...
from algo_atlas.integrations import git as git_service
from algo_atlas.integrations.exports import export_catalog
...
def test_export_is_deterministic_and_restorable(
    client, taxonomy, test_engine, tmp_path, monkeypatch
):
